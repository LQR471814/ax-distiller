...
func easyjsonCc70a961DecodeAxDistillerLibax(in *jlexer.Lexer, out *getNodesResult) {
...
func easyjsonCc70a961EncodeAxDistillerLibax(out *jwriter.Writer, in getNodesResult) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v getNodesResult) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCc70a961EncodeAxDistillerLibax(&w, v)
...
func (v *getNodesResult) UnmarshalJSON(data []byte) error {
	...
	easyjsonCc70a961DecodeAxDistillerLibax(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *getNodesResult) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCc70a961DecodeAxDistillerLibax(l, v)
}
func easyjsonCc70a961DecodeAxDistillerLibax1(in *jlexer.Lexer, out *cdpValue) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCc70a961EncodeAxDistillerLibax1(out *jwriter.Writer, in cdpValue) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v cdpValue) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCc70a961EncodeAxDistillerLibax1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *cdpValue) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCc70a961DecodeAxDistillerLibax1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *cdpValue) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCc70a961DecodeAxDistillerLibax1(l, v)
}
func easyjsonCc70a961DecodeAxDistillerLibax2(in *jlexer.Lexer, out *cdpNodeProp) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCc70a961EncodeAxDistillerLibax2(out *jwriter.Writer, in cdpNodeProp) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v cdpNodeProp) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCc70a961EncodeAxDistillerLibax2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *cdpNodeProp) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCc70a961DecodeAxDistillerLibax2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *cdpNodeProp) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCc70a961DecodeAxDistillerLibax2(l, v)
}
func easyjsonCc70a961DecodeAxDistillerLibax3(in *jlexer.Lexer, out *cdpNode) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonCc70a961EncodeAxDistillerLibax3(out *jwriter.Writer, in cdpNode) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v cdpNode) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCc70a961EncodeAxDistillerLibax3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *cdpNode) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonCc70a961DecodeAxDistillerLibax3(&r, v)
	return r.Error()
}
